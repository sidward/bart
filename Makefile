...
MODULES_ecalib = -lcalib -lestnoise
...
MODULES_bart = -lbox -lgrecon -lsense -lnoir -liter -llinops -lwavelet -llowrank -lnoncart -lcalib -lsimu -lsake -ldfwavelet -lnlops -lmoba -lestnoise
MODULES_sake = -lsake
